        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16 animate-in slide-in-from-bottom-8 duration-700">
                ...
                <p className="mt-4 text-slate-500 max-w-2xl mx-auto">
                    Led by Dr. Beate Setzer, our practice combines decades of human medical experience with advanced AI technology.
                </p>
            </div>
                ...
                {DOCTORS.map((doc, idx) => (
                    ...
                    >
                        ...
                        <div className="p-6">
                                ...
                                {doc.id === 'ai_assistant' ? (
                                    ...
                                    <>
                                        <span className="bg-blue-50 text-primary text-xs font-bold px-2 py-1 rounded flex items-center gap-1">
                                            <Award className="w-3 h-3" /> 30+ Yrs Exp
                                        </span>
                            ...
                            >
                                {doc.id === 'ai_assistant' ? 'Activate Voice Assistant' : 'View Full Profile'}
                            </button>
                        </div>
                    </div>
                ))}

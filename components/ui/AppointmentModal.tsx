...
import { X, Calendar, User, Clock, ChevronRight, CheckCircle, Info, ShieldCheck, CreditCard } from 'lucide-react';
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2">
                                    <div className="w-6 h-6 rounded-full bg-slate-200 overflow-hidden">
                                        <img src={selectedDoctor?.image} className="w-full h-full object-cover" alt="" />
                                    </div>
            ...
            <div className="p-4 border-t border-slate-100 bg-slate-50 flex justify-between items-center">
                ...
                {step < 4 ? (
                    <button 
                        onClick={handleNext}
                        disabled={
                            (step === 1 && (!serviceId || !doctorId)) || 
                            (step === 2 && (!date || !time)) ||
                            (step === 3 && (!patientData.name || !patientData.email || !consent))
                        }
